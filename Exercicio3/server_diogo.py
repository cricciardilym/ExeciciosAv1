...
servidor = "0.0.0.0"   # ip onde o servidor aceita requisições, nesse caso todos os da máquina do servidor
porta = 8730
...
def trata_conn(conn, cliente):
    ...
    while True:
        ...
        print(f"Recebi o resultado da votação {resultado_votacao} de {cliente}")
...
dict_votos_final = {'BRANCOS': 0, 'NULOS': 0, 'BRUNO': 0, 'PEDRO': 0, 'JOSEFA': 0}
mutex = Lock()
contador = 0
